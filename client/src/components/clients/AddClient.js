      ...
      <div className="bg-gray-900/95 shadow-sm border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
          <div className="flex items-center py-4 lg:py-6">
            ...
            <div>
              <h1 className="text-lg lg:text-xl xl:text-2xl font-bold text-white">Add New Client</h1>
        ...
        <div className="bg-gray-900/95 shadow-xl rounded-xl lg:rounded-2xl border border-gray-800 p-4 lg:p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 lg:space-y-6">
            ...
            <div className="space-y-4 lg:space-y-6">
              <h3 className="text-base lg:text-lg font-semibold text-white mb-4 lg:mb-6">Fitness Data</h3>
            ...
            {/* Medical Information */}
            <div className="space-y-4 lg:space-y-6">
              <h3 className="text-base lg:text-lg font-semibold text-white mb-4 lg:mb-6">Medical Information</h3>
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 lg:gap-4 pt-4 lg:pt-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="px-4 lg:px-6 py-2 lg:py-3 bg-gradient-to-r from-red-600 to-red-500 text-white rounded-lg lg:rounded-xl hover:from-red-700 hover:to-red-600 transition-all flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed text-xs lg:text-sm"
              >
                {loading ? (
