    ...
    <div className="min-h-screen bg-black">
          ...
          <div className="flex items-center py-6">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-400">
                Update {client?.personalInfo?.name}'s information and settings
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
                  >
          ...
          <div className="bg-gray-900/95 shadow-xl rounded-2xl border border-gray-800">
            <div className="px-6 py-6">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-lg font-medium text-white">Fitness Data</h3>
              </div>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Body Fat Percentage (%)</label>
                  <input
                    type="number"
                    step="0.1"
          ...
          <div className="bg-gray-900/95 shadow-xl rounded-2xl border border-gray-800">
            <div className="px-6 py-6">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-gray-300 mb-2">Secondary Goals</label>
                  <input
                    type="text"
                ...
                <div className="sm:col-span-2">
                  <label className="block text-sm font-medium text-gray-300 mb-2">Goal Notes</label>
                  <textarea
                    {...register('goalNotes')}
                    rows={3}
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
          ...
          <div className="bg-gray-900/95 shadow-xl rounded-2xl border border-gray-800">
            <div className="px-6 py-6">
              <h3 className="text-lg font-medium text-white mb-6">Medical Information</h3>
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-300 mb-2">Injuries</label>
                  <input
                    type="text"
                    {...register('injuries')}
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent"
          ...
          <div className="bg-gray-900/95 shadow-xl rounded-2xl border border-gray-800">
            <div className="px-6 py-6">
              <h3 className="text-lg font-medium text-white mb-6">Additional Notes</h3>
              <div>
          ...
          <div className="flex justify-end space-x-4">
            <button
              type="button"
              onClick={() => navigate(`/clients/${id}`)}
              className="px-6 py-3 border border-gray-700 text-white rounded-xl hover:bg-gray-800 transition-colors"
            >
              Cancel
            </button>
            <button
